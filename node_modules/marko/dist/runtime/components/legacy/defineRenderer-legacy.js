...
module.exports = function defineRenderer(renderingLogic) {
  ...
  if (!renderer) {
    ...
    renderer = function renderer(input, out) {
      ...
      var isReceivingNewInput = !component || component.aq_;
      var parentComponentDef;

      if (component) {
        delete component.aq_;
      }
      ...
      if (!component && componentLookup) {
        ...
        if ((parentComponentDef = componentsContext._N_) && key != null) {
      ...
      if (isReceivingNewInput) {
        ...
        newProps = newProps || component.ar_;
        widgetBody = component.as_;
