...
module.exports = function beginComponent(componentsContext, component, key, ownerComponentDef, isSplitComponent, isImplicitComponent, existingComponentDef) {
  ...
  var componentDef = existingComponentDef || (componentsContext._N_ = new ComponentDef(component, componentId, componentsContext));

  var ownerIsRenderBoundary = ownerComponentDef && ownerComponentDef._F_;
  var ownerWillRerender = ownerComponentDef && ownerComponentDef._G_ & FLAG_WILL_RERENDER_IN_BROWSER;
  // On the server
  if (!componentsContext.s_ && ownerWillRerender) {
    componentDef._G_ |= FLAG_WILL_RERENDER_IN_BROWSER;
    return componentDef;
  }
  ...
  if (out.global.oldHydrateNoCreate === true) {
    componentDef._G_ |= FLAG_OLD_HYDRATE_NO_CREATE;
  }
