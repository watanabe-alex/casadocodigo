...
var proto = AsyncStream.prototype = {
  ...
  aS_: function (tagName, elementAttrs, key, componentDef, props) {
    var str = "<" + tagName + markoAttr(props, key, componentDef) + attrsHelper(elementAttrs) + ">";
  ...
  aQ_: function (name, elementAttrs, key, componentDef, props) {
    var str = "<" + name + markoAttr(props, key, componentDef) + attrsHelper(elementAttrs) + ">";
